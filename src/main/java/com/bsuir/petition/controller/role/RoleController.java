...
public interface RoleController {
    ...
    void addRole(RoleDTO roleDTO) throws ServerException, ErrorInputException, SuchRoleExistsException;

    @PreAuthorize("hasAuthority('ADMIN')")
    @RequestMapping(value = "/role/{id}")
    void updateRole(RoleDTO roleDTO, long id) throws ErrorInputException, ServerException, RoleNotFoundException;
